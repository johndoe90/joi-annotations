...
var ObjectAnnotations = (function (_super) {
    ...
    ObjectAnnotations.prototype.assert = function (ref, schema, message) {
        return meta_1.Meta.addMetadata({
            type: this._type,
            validatorName: 'assert',
            validatorParameters: util_1.params(ref, schema, message)
        });
    };
    ...
    ObjectAnnotations.prototype.valid = function () {
        var values = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            values[_i - 0] = arguments[_i];
        }
        if (values.length === 1 && typeof values[0] === 'function' && meta_1.Meta.hasMetadata(values[0].prototype)) {
            return meta_1.Meta.addMetadata({
                priority: 3,
                type: this._type,
            ...
            return _super.prototype.valid.call(this, values);
        }
    };

...
var AnyAnnotations = (function () {
    ...
    AnyAnnotations.prototype.empty = function (schema) {
        return meta_1.Meta.addMetadata({
            type: this._type,
            validatorName: 'empty',
    ...
    AnyAnnotations.prototype.when = function (ref, options) {
        return meta_1.Meta.addMetadata({
            type: this._type,
            validatorName: 'when',
    ...
    AnyAnnotations.prototype.default = function (value, description) {
        return meta_1.Meta.addMetadata({
            type: this._type,
            validatorName: 'default',
            validatorParameters: util_1.params(value, description)
        });
    };
